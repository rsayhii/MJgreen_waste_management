...
<head>
    ...
    <title>Eco-Friendly Home Practices | MJ GREENS</title>
...
<body class="bg-gray-50">
    <x-hero 
      title="Eco-Friendly Practices for a Greener Home"
      subtitle="Practical tips from MJ Greens for residential waste reduction and responsible disposal in every household."
      bg="https://images.pexels.com/photos/1072824/pexels-photo-1072824.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    />
                ...
                <div class="lg:w-2/3">
                    <div class="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
                        <div class="flex items-center space-x-4 mb-8">
                            <span class="px-3 py-1 bg-amber-100 text-amber-700 text-xs font-semibold rounded-full">Lifestyle</span>
                            <span class="text-gray-500 text-sm"><i class="far fa-calendar mr-1"></i> Feb 05, 2026</span>
                            <span class="text-gray-500 text-sm"><i class="far fa-clock mr-1"></i> 12 min read</span>
                        </div>

                        <div class="article-content">
                            <h2>Sustainability Starts at Home</h2>
                            <p>While large-scale industrial changes are vital, individual actions in our own homes collectively make a massive impact. Creating a greener home isn't about being perfect; it's about making better choices every day.</p>

                            <h2>The Three R's: Reduce, Reuse, Recycle</h2>
                            <p>The hierarchy of waste management remains as relevant as ever. Focus first on reducing what you bring into your home, then finding ways to reuse items, and finally ensuring that what remains is recycled properly.</p>

                            <blockquote>
                                "A sustainable home is not just an environment; it's a statement of values and a commitment to the future."
                            </blockquote>

                            <h2>Practical Tips for Every Room</h2>
                            <p>From switching to biodegradable cleaning products in the kitchen to installing water-saving fixtures in the bathroom, there are countless ways to make your home more eco-friendly. MJ Greens encourages composting organic waste as a powerful way to reduce landfill contributions and create nutrient-rich soil for your garden.</p>
                        </div>
                        ...
                        <div class="mt-12 pt-8 border-t border-gray-100 flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Sustainability Advocate</p>
                                </div>
                            </div>
                        </div>
                    </div>
