...
<head>
    ...
    <title>Sustainable Infrastructure | MJ GREENS</title>
...
<body class="bg-gray-50">
    <x-hero 
      title="Sustainable Infrastructure: Building a Cleaner Tomorrow"
      subtitle="MJ Greens' approach to eco-friendly infrastructure and its impact on the environment through sustainable practices."
      bg="https://images.pexels.com/photos/1108572/pexels-photo-1108572.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    />
                ...
                <div class="lg:w-2/3">
                    <div class="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
                        <div class="flex items-center space-x-4 mb-8">
                            <span class="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full">Infrastructure</span>
                            <span class="text-gray-500 text-sm"><i class="far fa-calendar mr-1"></i> Feb 15, 2026</span>
                        ...
                        <div class="article-content">
                            <p class="text-xl text-gray-600 font-medium mb-8 leading-relaxed italic">
                                Building for the future means more than just using stronger materials; it's about creating systems that work in harmony with our environment.
                            </p>

                            <h2>Defining Sustainable Infrastructure</h2>
                            <p>Sustainable infrastructure refers to equipment and systems designed to provide essential services like energy, water, and waste management in a way that is environmentally, socially, and economically sustainable.</p>

                            <h2>Green Building Materials</h2>
                            <p>From recycled steel to carbon-absorbing concrete, the materials we use are evolving. MJ Greens advocates for the use of materials that have a lower carbon footprint and higher durability, reducing the need for frequent replacements and maintenance.</p>

                            <blockquote>
                                "Sustainability is no longer an option; it's a necessity for the survival and prosperity of our urban centers."
                            </blockquote>

                            <h2>Integrating Nature with Technology</h2>
                            <p>Modern infrastructure shouldn't displace nature. By incorporating green roofs, permeable pavements, and urban forests, we can create cities that manage stormwater naturally and reduce the urban heat island effect.</p>
                        </div>
